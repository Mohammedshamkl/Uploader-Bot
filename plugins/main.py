...
Made By @ShubhamOfficialR Powered by @ExclusiveDailyShows
"""
    HELP_TEXT = """
 ...
 **🌟 Server :** [Heroku](https://telegram.in)\n
"""
    START_BUTTONS = InlineKeyboardMarkup(
        [[
        InlineKeyboardButton('🤖 Channel', url='https://telegram.me/ExclusiveDailyShows'),
        InlineKeyboardButton('💬 Support', url='https://telegram.me/support')
        ],[
